...
import '../stylesheets/AddAuthorForm.css';
...
class AuthorForm extends Component {
  constructor(props) {
    ...
    this.handleAddBookToCollection = this.handleAddBookToCollection.bind(this);
  }
    ...
    return (
      <form onSubmit={this.handleSubmit}>
        ...
        <div className="AddAuthorForm__input">
          ...
          <input type="button" value="+" onClick={this.handleAddBookToCollection} />
        </div>
